...
- **Weekly recaps** — Sleeper-style HTML recaps with Game of the Week win-probability chart, per-team Roster Activity log (claims, drops, swaps, trades), and awards including Heart Attack (most lead changes), Comeback (winner with mid-week WP < 0.30), Whale (biggest single-day team total), and Dud (lowest single-day active starter).
